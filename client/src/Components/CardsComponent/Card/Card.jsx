...
const Card = (props) => {
  ...
  return (
    <Link to={`/detail/${props.id}`} key={props.id}>
      <div className="mt-5 mb-5 text-1xl text-center rounded-3xl border-1 w-400 h-400 flex-col flex-wrap flex jus items-center transition ease-in-out delay-150 bg-blue-200 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-300 duration-300 w-56 max-h-90 overflow-hidden">
        ...
        <p style={{ fontFamily: "Open Sans, sans-serif", marginTop: "2px" }}>
