...
const Newsletter = () => {
  ...
  return (
    <>
      <div className="container mx-82 w-full md:w-2/3 text-white text-center md:text-left mb-4 md:mb-0 flex flex-col items-center justify-center">
        {subscribed ? (
          ...
          <div className="flex flex-col justify-center items-center text-center">
            <p className="text-lg md:text-xl">
              Join our newsletter to receive our best offers to take care of
              your health
            </p>
