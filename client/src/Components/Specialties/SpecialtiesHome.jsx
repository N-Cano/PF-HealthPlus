  ...
  return (
    <div>
      ...
      <div className=" relative w-full h-full z-1 flex flex-col justify-center items-center pt-0 ">
        ...
        <div className="text-blue-900 font-semibold flex gap-4 flex-wrap items-center justify-center group h-[500px]">
          <div
            className="bg-white/80 group-hover:blur-sm hover:!blur-none group-hover:scale[0.90] hover:!scale-100 cursor-pointer mb-2 w-[250px] h-[230px] rounded-2xl"
            style={{ fontFamily: "Open Sans, sans-serif" }}>
          ...
          <div
            className="bg-white/80 group-hover:blur-md hover:!blur-none group-hover:scale[0.90] hover:!scale-100 cursor-pointer mb-2 w-[250px] h-[230px] rounded-2xl"
            style={{ fontFamily: "Open Sans, sans-serif" }}>
            <div className="flex justify-center items-center mt-2">
              <GiMedicalDrip />
            </div>
          ...
          <div
            className="bg-white/80 group-hover:blur-sm hover:!blur-none group-hover:scale[0.90] hover:!scale-100 cursor-pointer mb-2 w-[250px] h-[230px]  rounded-2xl hidden md:block lg:block"
            style={{ fontFamily: "Open Sans, sans-serif" }}>
            <div className="flex justify-center items-center mt-2">
              <GiStomach />
            </div>
            ...
            <p
              ...
              system and its diseases. Gastroenterologists diagnose and treat
              the diseases and disorders of the esophagus, stomach, intestines,
        ...
        {/* Mensaje Adicional */}
        <p
          className="text-2xl text-white font-semibold mt-2 mb-2 hidden md:block text-center  bg-blue-400/30 backdrop-blur-lg p-0 rounded-lg w-1/4"
          style={{ fontFamily: "Open Sans, sans-serif" }}>
