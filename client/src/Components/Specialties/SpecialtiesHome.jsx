  ...
  return (
    <div>
      ...
      <div className=" relative w-full h-full z-1 flex flex-col justify-center items-center pt-0 ">
        <h3
          className="text-4xl font-semibold text-center text-blue-600 mt-4 bg-white-400/80  p-0 rounded-lg w-1/4"
          style={{ fontFamily: "Rubik, sans-serif" }}>
          Our Services
        </h3>
        <p
          className="text-lg text-center mt-1 mb-8 text-gray-300  p-0 rounded-lg w-1/2"
