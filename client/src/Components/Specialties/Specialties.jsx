    ...
    <div
      ...
      <div style={{ backdropFilter: "blur(1px)" }} className="mb-[95px]">
        ...
        <div className="text-blue-900 font-semibold flex gap-4 flex-wrap items-center justify-center group h-[550px]">
          ...
          <div
            className="bg-white/50 group-hover:blur-md hover:!blur-none group-hover:scale[0.90] hover:!scale-100 cursor-pointer mb-2 w-[250px] h-[230px] rounded-2xl"
            style={{ fontFamily: "Open Sans, sans-serif" }}>
            <div className="flex justify-center items-center mt-2">
              <GiMedicalDrip />
            </div>
          ...
          <div
            className="bg-white/50 group-hover:blur-sm hover:!blur-none group-hover:scale[0.90] hover:!scale-100 cursor-pointer mb-2 w-[250px] h-[230px]  rounded-2xl hidden md:block"
            style={{ fontFamily: "Open Sans, sans-serif" }}>
            <div className="flex justify-center items-center mt-2">
              <GiStomach />
            </div>
