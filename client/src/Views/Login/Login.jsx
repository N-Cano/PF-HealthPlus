    ...
    <div className="h-screen flex justify-center items-start flex-col relative">
      <div className="bg-blue-400 rounded-2xl max-h-[32rem] h-full text-center p-8 ml-20 max-w-md w-full z-10">
        ...
        <div className="flex flex-col gap-2 mb-6">
          ...
          ></input>
          <i
            className={`bx ${showPassword ? "bx-hide" : "bx-show-alt"}`}
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <button
            ...
            className="bg-white p-2 rounded-2xl mb-4 w-56 flex items-center hover:text-gray-600 hover:scale-110 transition duration-300 ease-in-out"
          >
